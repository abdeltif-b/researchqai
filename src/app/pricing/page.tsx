          ...
          <TooltipProvider>
            {pricingItems.map(({ plan, tagline, quota, features }) => {
              ...
              return (
                ...
                >
                  {plan === "Pro" && (
                    <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-blue-800 to-blue-600 px-3 py-2 text-sm font-medium text-white">
                      Upgrade now
                    </div>
                  )}
